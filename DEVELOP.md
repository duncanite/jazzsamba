...
This image is built using: `docker.io/dubodubonduponey/base:builder-trixie-2025-11-01`

The runtime part is based on: `docker.io/dubodubonduponey/base:runtime-trixie-2025-11-01`

Both these images are built upon: `docker.io/dubodubonduponey/debian:trixie-2025-11-01`
...
These images provide very little - they are (mostly) barebone trixie with some ONBUILD
